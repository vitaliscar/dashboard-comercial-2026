...
export default function MinutasPage() {
  ...
  // Filtro por KPI -- "vencida" no es un estado real en DB (MinutaEstado solo
  // tiene pendiente/en_proceso/cumplido), se deriva de fechaLimite < hoy con
  // estado != cumplido. Pedido del usuario 2026-09-04: las cards de KPI eran
  // puramente decorativas, no filtraban nada al hacer clic.
  ...
  // Base para las cards de KPI -- solo filtrada por sucursal, NUNCA por
  // estadoFilter, para que los conteos no se auto-reduzcan al hacer clic en
  // una card (si no, "Pendientes" pasaría a mostrar el mismo número que Total).
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Cards clicables como filtro rápido -- antes eran puramente
          decorativas, pedido del usuario 2026-09-04 hacerlas funcionales. */}
                      ...
                      <EmptyHeader>
                        ...
                        <EmptyTitle>
                          {(minutas?.length ?? 0) === 0
                            ...
                            : "Ninguna minuta coincide con el filtro"}
                        </EmptyTitle>
                        {(minutas?.length ?? 0) === 0 ? (
                          canCreate && (
                            <EmptyDescription>
