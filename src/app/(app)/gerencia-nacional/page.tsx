...
import { getResumenMensualAction } from "@/lib/actions/gerencia-nacional";
...
export default function GerenciaNacionalPage() {
  ...
  // ocurre en memoria abajo, así que cambiar esos filtros no dispara un nuevo round-trip.
  const { data: resumenAnual, isLoading } = useQuery({
    queryKey: ["gerencia-nacional-resumen", anio],
    enabled: canView,
    queryFn: () => getResumenMensualAction({ anio }),
  });
