            ...
            <div key={r.id} className="p-3 space-y-2 bg-card">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  <span className="font-mono font-bold">{money(r.meta)}</span>
                </div>
                <div>
                  <span className="text-muted-foreground text-[10px]">Vendido:</span>{" "}
                  <span className="font-mono font-bold">{money(r.facturado)}</span>
                </div>
              </div>
              <div className="flex items-center justify-between text-xs pt-1 border-t border-border/50">
                <span className="text-muted-foreground text-[10px]">Diferencia:</span>
