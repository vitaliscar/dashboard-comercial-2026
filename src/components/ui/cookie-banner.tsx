    ...
    <div className="fixed bottom-4 right-4 z-50 max-w-md rounded-xl border border-border bg-card p-5 shadow-2xl backdrop-blur-md">
      <div className="flex flex-col space-y-3">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          Utilizamos cookies esenciales y analíticas para garantizar la seguridad del sistema y
          mejorar la experiencia de usuario según las normativas GDPR y de protección de datos.
        </p>
